<script>
	...
	import IconBrowseItemUser from '$lib/assets/icons/browse/IconBrowseItemUser.svelte'
</script>

<div
	role="status"
	class="w-96 border border-gray-200 rounded shadow overflow-hidden md:p-6 dark:border-gray-700 mx-3">
