...
<div class="stats shadow bg-base-200">
	<div class="stat">
		...
		<div class="stat-desc">{viewsMonthlyIncr.monthlyChange>=0 ? `${viewsMonthlyIncr.monthlyChange}% more` : `${-viewsMonthlyIncr.monthlyChange}% less`}  than last month</div>
	</div>
	...
	<div class="stat">
		...
		<div class="stat-desc">{streakMonthlyIncr.monthlyChange>=0 ? `${streakMonthlyIncr.monthlyChange}% more` : `${-streakMonthlyIncr.monthlyChange}% less` } than last month</div>
	</div>
	...
	<div class="stat">
		...
		<div class="stat-desc">{totalMinsMonthlyIncr.monthlyChange>=0 ? `${totalMinsMonthlyIncr.monthlyChange}% more` : `${-totalMinsMonthlyIncr.monthlyChange}% less` } than last month</div>
	</div>
